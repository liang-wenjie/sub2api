...
type User struct {
	...
	// LastImageAPIKeyID holds the value of the "last_image_api_key_id" field.
	LastImageAPIKeyID *int64 `json:"last_image_api_key_id,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit, user.FieldLastImageAPIKeyID:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldLastImageAPIKeyID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field last_image_api_key_id", values[i])
			} else if value.Valid {
				_m.LastImageAPIKeyID = new(int64)
				*_m.LastImageAPIKeyID = value.Int64
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	if v := _m.LastImageAPIKeyID; v != nil {
		builder.WriteString("last_image_api_key_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteByte(')')
